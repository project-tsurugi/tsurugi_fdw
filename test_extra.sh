#!/bin/bash
# Fix below
# connection PGPORT number
PGPORT=5432
# Fix above

PSQLBIN=`pg_config --bindir`
...
$PSQLBIN/psql -p $PGPORT -a postgres < $TEST_SQL_OTHER_COMPONENT_ERROR > $TEST_RESULTS_DIR/$TEST_RESULTS_OUTPUT_FILE_OGAWAYAMA 2>&1
...
do
    ...
    $PSQLBIN/psql -p $PGPORT -a postgres < $TEST_SQL_OTHER_COMPONENT_ERROR > $TEST_RESULTS_DIR/$TEST_RESULTS_OUTPUT_FILE_METADATA 2>&1
