...
SELECT * from test2;
INSERT INTO test2 VALUES (1,NULL,NULL,NULL,NULL,NULL);
SELECT * from test2;

INSERT INTO test3 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test3;
INSERT INTO test3 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test3;

INSERT INTO test4_1 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test4_1;
INSERT INTO test4_1 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test4_1;

INSERT INTO test4_2 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test4_2;
INSERT INTO test4_2 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test4_2;

SELECT * from test5;
INSERT INTO test5 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test5;
INSERT INTO test5 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test5;
INSERT INTO test5 VALUES (NULL,NULL,NULL,NULL,'AAA',NULL);
SELECT * from test5;

INSERT INTO test7 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test7;
INSERT INTO test7 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test7;

SELECT * from test9;
INSERT INTO test9 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test9;
INSERT INTO test9 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test9;
INSERT INTO test9 VALUES (1,NULL,3.24,-2.27,'A',NULL);
SELECT * from test9;

INSERT INTO test11 VALUES (1,1000,3.24,-2.27,'ABC','ABCDEFABCDEF');
SELECT * from test11;
INSERT INTO test11 VALUES (NULL,NULL,NULL,NULL,NULL,NULL);
SELECT * from test11;
