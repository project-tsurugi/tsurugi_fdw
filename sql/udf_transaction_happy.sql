/* Test case: happy path - UDF tg_set_xxxxx()/tg_show_transaction() */
...
SELECT tg_execute_ddl('DROP TABLE re_table1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE re_table2', 'tsurugidb');
