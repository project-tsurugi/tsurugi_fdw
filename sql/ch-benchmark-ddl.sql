...
INSERT INTO order_line (ol_w_id, ol_d_id, ol_o_id, ol_number, ol_i_id, ol_delivery_d, ol_amount, ol_supply_w_id, ol_quantity, ol_dist_info) VALUES (974,1,1,1,49876,'2020-09-01 06:19:55',0.00,5,2.09,'ige');
INSERT INTO order_line (ol_w_id, ol_d_id, ol_o_id, ol_number, ol_i_id, ol_delivery_d, ol_amount, ol_supply_w_id, ol_quantity, ol_dist_info) VALUES (974,1,1,1,49876,'2020-09-01 06:19:55',0.00,5,2.09,'ige');
INSERT INTO new_order (no_w_id, no_d_id, no_o_id) VALUES (2920,1,1);
INSERT INTO new_order (no_w_id, no_d_id, no_o_id) VALUES (2839,1,1);
INSERT INTO new_order (no_w_id, no_d_id, no_o_id) VALUES (2839,1,1);
INSERT INTO stock (s_w_id, s_i_id, s_quantity, s_ytd, s_order_cnt, s_remote_cnt, s_data, s_dist_01, s_dist_02, s_dist_03, s_dist_04, s_dist_05, s_dist_06, s_dist_07, s_dist_08, s_dist_09, s_dist_10) VALUES (1,1,73,0,0,1,'v7HGGr','fk5m8','ItiMb?','o@Kqn','D8CTTn','Djuyt6','25s0by','F5is3TawH','jYjPHA','Aidr','sB09');
INSERT INTO stock (s_w_id, s_i_id, s_quantity, s_ytd, s_order_cnt, s_remote_cnt, s_data, s_dist_01, s_dist_02, s_dist_03, s_dist_04, s_dist_05, s_dist_06, s_dist_07, s_dist_08, s_dist_09, s_dist_10) VALUES (1,1,73,0,0,1,'v7HGGr','fk5m8','ItiMb?','o@Kqn','D8CTTn','Djuyt6','25s0by','F5is3TawH','jYjPHA','Aidr','sB09');
INSERT INTO orders (o_w_id, o_d_id, o_id, o_c_id, o_carrier_id, o_ol_cnt, o_all_local, o_entry_d) VALUES (974,1,1,1,8,7,1,'2020-09-01 06:19:55');
INSERT INTO orders (o_w_id, o_d_id, o_id, o_c_id, o_carrier_id, o_ol_cnt, o_all_local, o_entry_d) VALUES (974,1,1,1,8,7,1,'2020-09-01 06:19:55');
INSERT INTO orders_secondary (o_d_id, o_w_id, o_c_id, o_id) VALUES (893,1,1,4);
INSERT INTO orders_secondary (o_d_id, o_w_id, o_c_id, o_id) VALUES (893,1,1,4);
INSERT INTO history (h_c_id, h_c_d_id, h_c_w_id, h_d_id, h_w_id, h_date, h_amount, h_data) VALUES (1,1,1,1,1,'2020-09-01 06:19:55',10.00,'?qO6YMvDuCVyQQ');
INSERT INTO history (h_c_id, h_c_d_id, h_c_w_id, h_d_id, h_w_id, h_date, h_amount, h_data) VALUES (1,1,1,1,1,'2020-09-01 06:19:55',10.00,'?qO6YMvDuCVyQQ');
INSERT INTO customer (c_w_id, c_d_id, c_id, c_discount, c_credit, c_last, c_first, c_credit_lim, c_balance, c_ytd_payment, c_payment_cnt, c_delivery_cnt, c_street_1, c_street_2, c_city, c_state, c_zip, c_phone, c_since, c_middle, c_data) VALUES (1,1,1,882711111,'OE','YGw89hId','BARBARBAR',50000.00,0.0135,-10.00,1,53,'kU1gw6cmC?b0','0Evto','WE9wusQn8MlIfyrWwIs','5Y','VlQIzx7Gl','0120-11111-12222','2020-09-01 06:19:55','GC','@GvTnhlqcYlW');
INSERT INTO customer (c_w_id, c_d_id, c_id, c_discount, c_credit, c_last, c_first, c_credit_lim, c_balance, c_ytd_payment, c_payment_cnt, c_delivery_cnt, c_street_1, c_street_2, c_city, c_state, c_zip, c_phone, c_since, c_middle, c_data) VALUES (1,1,1,882711111,'OE','YGw89hId','BARBARBAR',50000.00,0.0135,-10.00,1,53,'kU1gw6cmC?b0','0Evto','WE9wusQn8MlIfyrWwIs','5Y','VlQIzx7Gl','0120-11111-12222','2020-09-01 06:19:55','GC','@GvTnhlqcYlW');
INSERT INTO customer_secondary (c_d_id, c_w_id, c_last, c_first, c_id) VALUES (4,1,'bZK8UUzZk6OJQwbi','BARBARPRI',829611111);
INSERT INTO customer_secondary (c_d_id, c_w_id, c_last, c_first, c_id) VALUES (4,1,'bZK8UUzZk6OJQwbi','BARBARPRI',829611111);
INSERT INTO district (d_w_id, d_id, d_ytd, d_tax, d_next_o_id, d_name, d_street_1, d_street_2, d_city, d_state, d_zip) VALUES (1,1,0.1224,30000.00,3001,'7KxYQrnz','5fg6lud','IHKgOEqlYdZ','2Jwyu80wQLC','Tn','HeUiU8zV2');
INSERT INTO district (d_w_id, d_id, d_ytd, d_tax, d_next_o_id, d_name, d_street_1, d_street_2, d_city, d_state, d_zip) VALUES (1,1,0.1224,30000.00,3001,'7KxYQrnz','5fg6lud','IHKgOEqlYdZ','2Jwyu80wQLC','Tn','HeUiU8zV2');
INSERT INTO item (i_id, i_name, i_price, i_data, i_im_id) VALUES (1,'7KxYQrnz',0.1224,'5fg6lud3tkcnGw',185311111);
INSERT INTO item (i_id, i_name, i_price, i_data, i_im_id) VALUES (1,'7KxYQrnz',0.1224,'5fg6lud3tkcnGw',185311111);
INSERT INTO warehouse (w_id, w_ytd, w_tax, w_name, w_street_1, w_street_2, w_city, w_state, w_zip) VALUES (1,0.078,300000.00,'HO73DCcj6s','67oATAPEmE5','mM48NK@U7TQTK@Z@ma','sitmvvuwAzB','g5','405911111');
INSERT INTO warehouse (w_id, w_ytd, w_tax, w_name, w_street_1, w_street_2, w_city, w_state, w_zip) VALUES (1,0.078,300000.00,'HO73DCcj6s','67oATAPEmE5','mM48NK@U7TQTK@Z@ma','sitmvvuwAzB','g5','405911111');
INSERT INTO nation (n_nationkey, n_name, n_regionkey, n_comment) VALUES (48,'ALGERIA',0,'the bravely busy theodolites will dazzle blithely according to the never silent');
INSERT INTO nation (n_nationkey, n_name, n_regionkey, n_comment) VALUES (48,'ALGERIA',0,'the bravely busy theodolites will dazzle blithely according to the never silent');
INSERT INTO supplier (su_suppkey, su_name, su_address, su_nationkey, su_phone, su_acctbal, su_comment) VALUES (0,'Supplier#000000000','UFUqtuYH2qwWrqma@FRKKRsTeZpC5pQiKqk6g',103,'10-520-573-2995',7942.04,' slyly on the sometimes permanent somas -- enticingly daring attai');
INSERT INTO supplier (su_suppkey, su_name, su_address, su_nationkey, su_phone, su_acctbal, su_comment) VALUES (0,'Supplier#000000000','UFUqtuYH2qwWrqma@FRKKRsTeZpC5pQiKqk6g',103,'10-520-573-2995',7942.04,' slyly on the sometimes permanent somas -- enticingly daring attai');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (0,'AFRICA',' ? closely enticing attainments around the quietly careful dinos may was idly over the slowly st');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (1,'AMERICA','the pearls : doggedly final platelets alongside of the quickly even pinto beans sh');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (2,'ASIA','s try to engage quickly past the regul');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (3,'EUROPE','ss the idly ironic somas ! evenly busy warthogs past the slyly even notornis must print q');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (4,'MIDDLE EAST','ructions ; quietly sly dolphins besi');
INSERT INTO region (r_regionkey, r_name, r_comment) VALUES (4,'MIDDLE EAST','ructions ; quietly sly dolphins besi');
