...
PREPARE prep_select AS SELECT * FROM fdw_dml_basic_table_1 ORDER BY c1;
EXECUTE prep_insert (1);
EXECUTE prep_insert (100);
EXECUTE prep_insert (10);
EXECUTE prep_select;
...
--- WHERE variation
---- Equality pattern
PREPARE prep_select_eq (integer) AS
  SELECT * FROM fdw_dml_basic_table_1 WHERE c1 = $1 ORDER BY c1;
EXECUTE prep_select_eq (10);
DEALLOCATE prep_select_eq;
---- Inequality pattern
PREPARE prep_select_ne (integer) AS
  SELECT c1 FROM fdw_dml_basic_table_1 WHERE c1 <> $1 ORDER BY c1;
EXECUTE prep_select_ne (10);
DEALLOCATE prep_select_ne;
---- Greater than pattern
PREPARE prep_select_gt (integer) AS
  SELECT * FROM fdw_dml_basic_table_1 WHERE c1 > $1 ORDER BY c1;
EXECUTE prep_select_gt (10);
DEALLOCATE prep_select_gt;
---- Greater than or equal pattern
PREPARE prep_select_ge (integer) AS
  SELECT c1 FROM fdw_dml_basic_table_1 WHERE c1 >= $1 ORDER BY c1;
EXECUTE prep_select_ge (10);
DEALLOCATE prep_select_ge;
---- Less than pattern
PREPARE prep_select_lt (integer) AS
  SELECT * FROM fdw_dml_basic_table_1 WHERE c1 < $1 ORDER BY c1;
EXECUTE prep_select_lt (10);
DEALLOCATE prep_select_lt;
---- Less than or equal pattern
PREPARE prep_select_le (integer) AS
  SELECT c1 FROM fdw_dml_basic_table_1 WHERE c1 <= $1 ORDER BY c1;
EXECUTE prep_select_le (0);
DEALLOCATE prep_select_le;

--- ORDER variation
---- Default order pattern
PREPARE prep_select_def AS
  SELECT * FROM fdw_dml_basic_table_1 ORDER BY c1;
EXECUTE prep_select_def;
DEALLOCATE prep_select_def;
---- Ascending order pattern
PREPARE prep_select_asc AS
  SELECT * FROM fdw_dml_basic_table_1 ORDER BY c1 ASC;
EXECUTE prep_select_asc;
DEALLOCATE prep_select_asc;
---- Descending order pattern
PREPARE prep_select_desc AS
  SELECT * FROM fdw_dml_basic_table_1 ORDER BY c1 DESC;
EXECUTE prep_select_desc;
DEALLOCATE prep_select_desc;
...
EXECUTE prep_delete (2, 4);
EXECUTE prep_select_all;
EXECUTE prep_delete (2, 4);
EXECUTE prep_select_all;
DEALLOCATE prep_delete;
--- Delete without condition
PREPARE prep_delete AS DELETE FROM fdw_dml_basic_table_1;
EXECUTE prep_delete;
EXECUTE prep_select_all;
EXECUTE prep_delete;
EXECUTE prep_select_all;
...
PREPARE prep_insert
  ...
  INSERT INTO fdw_dml_basic_table_2 (c1, c2, c3, c4, c5)
    VALUES ($1, $2, $3, $4, $5);
EXECUTE prep_insert (1, 100, 1.1, '1st', '2025-01-01');
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_insert
  ...
  INSERT INTO fdw_dml_basic_table_2
    VALUES ($1, $2, $3, $4, $5);
EXECUTE prep_insert (3, 300, 3.3, NULL, '2025-03-03');
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_insert
  ...
  INSERT INTO fdw_dml_basic_table_2
    (c1, c2, c3, c4)
    VALUES ($1, $2, $3, $4);
EXECUTE prep_insert (2, 200, 2.2, '2nd');
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_insert (integer, bigint, varchar(100)) AS
  INSERT INTO fdw_dml_basic_table_2 (c1, c2, c4) VALUES ($1, $2, $3);
EXECUTE prep_insert (6, 600, '6th');
EXECUTE prep_select_all;
DEALLOCATE prep_insert;

--- Partial column insert with 2 columns
PREPARE prep_insert (integer, double precision) AS
  INSERT INTO fdw_dml_basic_table_2 (c1, c3) VALUES ($1, $2);
EXECUTE prep_insert (7, 7.7);
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_insert
  ...
  INSERT INTO fdw_dml_basic_table_2
    (c3, c1, c2, c5, c4)
    VALUES ($1, $2, $3, $4, $5);
EXECUTE prep_insert (4.4, 4, 400, '2025-04-04', '4th');
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_select (double precision, double precision) AS
  SELECT * FROM fdw_dml_basic_table_2 WHERE c3 IN ($1, $2) ORDER BY c1;
EXECUTE prep_select (1.1, 2.2);
DEALLOCATE prep_select;
...
PREPARE prep_delete AS DELETE FROM fdw_dml_basic_table_2;
PREPARE prep_select AS SELECT * FROM fdw_dml_basic_table_2;
EXECUTE prep_delete;
EXECUTE prep_select;
DEALLOCATE prep_delete;
DEALLOCATE prep_select;
...
EXECUTE prep_insert (1, 11, 111, 1.1, 1.11, 1, 'aaa');
EXECUTE prep_insert (2, 22, 222, 2.2, 2.22, 2, 'bbb');
EXECUTE prep_insert (3, 33, 333, 3.3, 3.33, 3, 'ccc');
EXECUTE prep_insert (4, 44, 444, 4.4, 4.44, 1, 'aaa');
EXECUTE prep_insert (5, 55, 555, 5.5, 5.55, 2, 'bbb');
DEALLOCATE prep_insert;
...
EXECUTE prep_insert (1, 11, 111, 1.1, 1.11, 'one', 'first');
EXECUTE prep_insert (2, 22, 222, 2.2, 2.22, 'two', 'second');
EXECUTE prep_insert (3, 33, 333, 3.3, 3.33, 'three', 'third');
DEALLOCATE prep_insert;
...
EXECUTE prep_insert (2, 22, 222, 2.2, 2.22, 'two', 'second');
EXECUTE prep_insert (3, 33, 333, 3.3, 3.33, 'three', 'third');
EXECUTE prep_insert (4, NULL, NULL, NULL, NULL, 'NULL', NULL);
EXECUTE prep_insert (5, 55, 555, 5.5, 5.55, 'five', 'fifth');
DEALLOCATE prep_insert;
...
PREPARE prep_select (integer) AS
  SELECT *
    ...
    WHERE a.c2 = $1;
EXECUTE prep_select (22);
EXECUTE prep_select (44);
DEALLOCATE prep_select;
...
-- Initialization of test data
PREPARE prep_insert (integer, text, numeric, integer, integer) AS
  INSERT INTO fdw_select_variation_table_1 VALUES ($1, $2, $3, $4, $5);
EXECUTE prep_insert (1000, 'name-1000', 100000, NULL, NULL);
EXECUTE prep_insert (1001, 'name-1001', 60000, 1, 1002);
EXECUTE prep_insert (1002, 'name-1002', 75000, 1, 1000);
EXECUTE prep_insert (1003, 'name-1003', 50000, 2, 1005);
EXECUTE prep_insert (1004, 'name-1004', 55000, 3, 1005);
EXECUTE prep_insert (1005, 'name-1005', 80000, 3, 1000);
DEALLOCATE prep_insert;

PREPARE prep_insert (integer, varchar(10)) AS
  INSERT INTO fdw_select_variation_table_2 VALUES ($1, $2);
EXECUTE prep_insert (1, 'dep-1');
EXECUTE prep_insert (2, 'dep-2');
EXECUTE prep_insert (3, 'dep-3');
EXECUTE prep_insert (4, 'dep-4');
DEALLOCATE prep_insert;
...
PREPARE prep_select_all AS SELECT * FROM fdw_ins_variation_table ORDER BY c_int;
...
-- INSERT ... VALUES (...), ...
PREPARE prep_insert (integer, text, integer, integer, text, integer) AS
  INSERT INTO fdw_ins_variation_table 
    (c_int, c_vchr, c_big, c_chr, c_dec)
    VALUES ($1, $2, $3, 'b', 34), ($4, $5, $6, 'c', 35);
EXECUTE prep_insert (4, 'key4', 400, 5, 'key5', 500);
EXECUTE prep_select_all;
DEALLOCATE prep_insert;
...
PREPARE prep_update (integer, bigint) AS
  UPDATE fdw_upd_variation_table
    SET c_int = $1, c_big = c_big + 101
    WHERE c_big = $2;
EXECUTE prep_update (1, 11);
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (char) AS
  UPDATE fdw_upd_variation_table
    SET c_dbl = c_dbl * 2 / 10, c_chr = 'k' WHERE c_chr = $1;
EXECUTE prep_update ('a');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (varchar) AS
  UPDATE fdw_upd_variation_table
    SET c_chr = 'a', c_vchr = c_vchr || '_updated'
    WHERE c_vchr = $1;
EXECUTE prep_update ('val_1');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (date) AS
  UPDATE fdw_upd_variation_table
    SET c_vchr = 'val_1', c_date = '2025-08-08'
    WHERE c_date = $1;
EXECUTE prep_update ('2025-01-01');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (time) AS
  UPDATE fdw_upd_variation_table
    SET c_date = '2025-01-01', c_time = '12:00:00'
    WHERE c_time = $1;
EXECUTE prep_update ('01:00:00');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (timestamp) AS
  UPDATE fdw_upd_variation_table
    SET c_time = '01:00:00', c_tstmp = '2025-08-08 12:00:00'
    WHERE c_tstmp = $1;
EXECUTE prep_update ('2025-01-01 01:00:00');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
PREPARE prep_update (timestamp with time zone) AS
  UPDATE fdw_upd_variation_table
    SET c_tstmp = '2025-01-01 01:00:00', c_tstmptz = '2025-08-08 12:00:00+09'
    WHERE c_tstmptz = $1;
EXECUTE prep_update ('2025-01-01 01:00:00+09');
EXECUTE prep_select;
DEALLOCATE prep_update;
DEALLOCATE prep_select;
...
EXECUTE prep_insert (1, 'key1', 10);
EXECUTE prep_insert (2, 'key2', 20);
EXECUTE prep_insert (3, 'key3', 30);
EXECUTE prep_insert (4, 'key4', 40);
EXECUTE prep_insert (5, 'key5', 50);
EXECUTE prep_insert (6, 'key6', 60);
EXECUTE prep_insert (7, 'key7', 70);
EXECUTE prep_insert (8, 'key8', 80);
EXECUTE prep_insert (9, 'key9', 90);
EXECUTE prep_insert (10, 'key10', 100);
DEALLOCATE prep_insert;
...
PREPARE prep_delete (text, integer) AS
  DELETE
    FROM fdw_del_variation_table
    WHERE (key_col <> $1) AND (value_col < $2);
EXECUTE prep_delete ('key2', 90);
EXECUTE prep_select;
DEALLOCATE prep_delete;
