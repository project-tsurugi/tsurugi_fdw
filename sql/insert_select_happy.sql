...
DROP FOREIGN TABLE insert_select_happy CASCADE;
DROP FOREIGN TABLE integer1 CASCADE;
DROP FOREIGN TABLE bigint1 CASCADE;
DROP FOREIGN TABLE real1 CASCADE;
DROP FOREIGN TABLE double1 CASCADE;
DROP FOREIGN TABLE char_length_1 CASCADE;
DROP FOREIGN TABLE varchar_length_1 CASCADE;
DROP FOREIGN TABLE char_length_10 CASCADE;
DROP FOREIGN TABLE varchar_length_10 CASCADE;
