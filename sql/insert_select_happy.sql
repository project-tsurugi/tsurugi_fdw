...
SELECT tg_execute_ddl('DROP TABLE insert_select_happy', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE integer1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE bigint1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE real1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE double1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE char_length_1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE varchar_length_1', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE char_length_10', 'tsurugidb');
SELECT tg_execute_ddl('DROP TABLE varchar_length_10', 'tsurugidb');
